...
Each persona's full, detailed prompt lives in `.claude/agents/<name>.md` — read that file for complete instructions before acting as that role.
...
**Full prompt**: Read `.claude/agents/pm.md` for complete instructions.
...
**Recommended model**: opus
**Full prompt**: Read `.claude/agents/architect.md` for complete instructions.
...
**Full prompt**: Read `.claude/agents/coder.md` for complete instructions.
...
**Full prompt**: Read `.claude/agents/tester.md` for complete instructions.
